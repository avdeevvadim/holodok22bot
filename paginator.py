"""
Based on Kseniya Andreeva library python-telegram-bot-pagination
https://github.com/ksinn/python-telegram-bot-pagination
Added current_page_format option
"""
...
class InlineKeyboardPaginator:
    ...
    def __init__(self, page_count, current_page=1, current_page_format=True, data_pattern='{page}'):
        ...
        self.current_page_format = current_page_format
